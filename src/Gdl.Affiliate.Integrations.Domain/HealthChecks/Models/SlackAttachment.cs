...
namespace Gdl.Affiliate.Integrations.HealthChecks.Models
{
    /// <summary>
    ...
    public class SlackAttachment
    {
        ...
        /// </param>
        public SlackAttachment(string fallbackText)
        {
        ...
        public SlackAttachment(string fallbackText, string pretext)
        {
            Fallback = fallbackText;
            Pretext = pretext;
        }
        ...
        public SlackAttachment SetFooter(string footerText, string footerIcon, DateTime footerTimeStamp)
        {
            Footer = footerText;
        ...
        /// </param>
        /// <returns>The updated attachment</returns>
        public SlackAttachment AddField(string title, string value, bool _short = false)
        {
            if (Fields == null) Fields = new List<SlackField>();
        ...
        /// <returns>The updated attachment</returns>
        public SlackAttachment SetAuthor(string authorName, string authorLink = null, string authorIcon = null)
        {
        ...
        /// <returns>The updated attachment</returns>
        public SlackAttachment SetImage(string imageUrl)
        {
            ImageUrl = imageUrl;
            return this;
        }
        ...
        /// <returns>The updated attachment</returns>
        public SlackAttachment SetColor(SlackColor color)
        {
            switch (color)
            {
                case SlackColor.Red:
                    Color = "danger";
                    break;
                case SlackColor.Orange:
                    Color = "warning";
                    break;
                case SlackColor.Green:
                    Color = "good";
                    break;
                default:
                    Color = null;
        ...
        /// <returns>The updated attachment</returns>
        public SlackAttachment SetColor(string colorHexCode)
        {
            Color = colorHexCode;
            return this;
        }
