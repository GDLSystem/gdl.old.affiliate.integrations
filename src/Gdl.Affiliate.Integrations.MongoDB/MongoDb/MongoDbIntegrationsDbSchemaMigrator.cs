...
using Gdl.Affiliate.Integrations.Data;
using Volo.Abp.Data;
...
{
    public class MongoDbIntegrationsDbSchemaMigrator : IIntegrationsDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbIntegrationsDbSchemaMigrator(IServiceProvider serviceProvider)
        {
