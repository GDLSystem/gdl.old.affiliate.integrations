...
{
    public class IntegrationsDatabaseCheck : IHealthCheck, ITransientDependency
    {
        protected readonly IIdentityRoleRepository IdentityRoleRepository;

        public IntegrationsDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
        {
